...
const renderPreview = (page, index) => {
  return (
    <div key={index}>
      <PostPreview body={page.attributes.preview} path={page.path} title={page.attributes.title} published={page.attributes.published}></PostPreview>
    </div>
  )
}
...
const renderPost = (page) => {
  return (
    <div key={0}>
      ...
      <Post body={page.body} path={page.path} title={page.attributes.title} published={page.attributes.published}></Post>
    </div>
  )
}
